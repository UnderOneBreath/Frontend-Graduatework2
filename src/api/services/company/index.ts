...
export async function getCompanies(): Promise<CompanyResponse[]> {
	//const res = await apiClient.get<BackendResponse<CompanyResponse[]>>(API_ROUTES.companies.list);
...
export async function getCompanyById(id: string): Promise<CompanyResponse> {
	//const res = await apiClient.get<BackendResponse<CompanyResponse>>(API_ROUTES.companies.get(id));
	//return res.data.data;
...
export async function createCompany(
	...
	//const res = await apiClient.post<BackendResponse<CompanyResponse>>(API_ROUTES.companies.list, data);
	//return res.data.data;
...
export async function updateCompany(
	...
	//const res = await apiClient.patch<BackendResponse<CompanyResponse>>(API_ROUTES.companies.get(id), data);
	//return res.data.data;
...
export async function deleteCompany(id: string): Promise<void> {
	//await apiClient.delete(API_ROUTES.companies.get(id));
